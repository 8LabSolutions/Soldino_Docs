...
\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.20\textwidth}
	...
	R1F5	&	Obbligatorio	&	Il governo può coniare \textit{Cubit}\glo	&	Capitolato \\ UC9	\tabularnewline
	R1F5.1	&	Obbligatorio	&	Il governo può inserire la quantità di \textit{Cubit}\glosp da coniare	&	Interno \\ UC9	\tabularnewline
	R1F6	&	Obbligatorio	&	Il governo può distribuire \textit{Cubit}\glosp a cittadini ed aziende	&	Capitolato \\ UC10	\tabularnewline
	R1F6.1	&	Obbligatorio	&	Il governo può determinare l’ammontare di \textit{Cubit}\glosp pro capite da trasferire	&	Interno\\ UC10.1	\tabularnewline
	...
	R1F6.3	&	Obbligatorio	&	La distribuzione dei \textit{Cubit}\glosp da parte del governo fallisce mostrando un errore se è stata raggiunta la soglia massima distribuibile	&	Interno\\ UC10.4	\tabularnewline
	...
	R1F15.1	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include la data dell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.2	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include il numero dell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.3	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include i prodotti inclusi nell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.4	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include il totale IVA dell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.5	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include il  prezzo lordo\glosp dell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.6	&	Obbligatorio	&	La visualizzazione di un acquisto effettuato include l'indirizzo di spedizione dell'acquisto	&	Interno\\ UC14.1	\tabularnewline
	R1F15.7	&	Obbligatorio	&	Aziende e cittadini possono visualizzare e gestire le conferme d'ordine da approvare	&	Interno \\ UC14.2	\tabularnewline
	...
	R1F17.1	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include la data della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.2	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il numero della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.3	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include i prodotti includi della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.4	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il totale IVA della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.5	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il prezzo lordo\glosp della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.6	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include l'indirizzo di spedizione della vendita	&	Interno\\ UC14.1	\tabularnewline
	R1F17.7	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include la data di approvazione dell'acquisto	&	Interno\\ UC14.3	\tabularnewline
	R1F17.8	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il nome dell'acquirente se esso è un cittadino	&	Interno\\ UC14.3	\tabularnewline
	R1F17.9	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il cognome dell'acquirente se esso è un cittadino	&	Interno\\ UC14.3	\tabularnewline
	R1F17.10	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include il nome dell'azienda-cliente se essa è l'acquirente	&	Interno\\ UC14.3	\tabularnewline
	R1F17.11	&	Obbligatorio	&	La visualizzazione di una vendita effettuata include la partita IVA dell'azienda-cliente se essa è l'acquirente	&	Interno\\ UC14.3	\tabularnewline
	...
	R1F19.7.1	&	Obbligatorio	&	La visualizzazione di una fattura include la data della fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.2	&	Obbligatorio	&	La visualizzazione di una fattura include il numero identificativo della fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.3	&	Obbligatorio	&	La visualizzazione di una fattura include la data dell'ordine relativo alla fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.4	&	Obbligatorio	&	La visualizzazione di una fattura include il numero identificativo dell'ordine relativo alla fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.5	&	Obbligatorio	&	La visualizzazione di una fattura include la visualizzazione dei prodotti	&	Interno\\ UC15.8	\tabularnewline
	...
	R1F19.7.6	&	Obbligatorio	&	La visualizzazione di una fattura include l'importo totale IVA della fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.7	&	Obbligatorio	&	La visualizzazione di una fattura include l'importo totale della fattura	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.8	&	Obbligatorio	&	La visualizzazione di una fattura include il nome dell'azienda emittente	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.9	&	Obbligatorio	&	La visualizzazione di una fattura include la partita IVA dell'azienda emittente	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.10	&	Obbligatorio	&	La visualizzazione di una fattura include il nome dell'acquirente se esso è un cittadino	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.11	&	Obbligatorio	&	La visualizzazione di una fattura include il cognome dell'acquirente se esso è un cittadino	&	Interno\\ UC15.8	\tabularnewline
	...
	R1F19.7.13	&	Obbligatorio	&	La visualizzazione di una fattura include la partita IVA dell'azienda-cliente se essa è l'acquirente	&	Interno\\ UC15.8	\tabularnewline
	R1F19.7.14	&	Obbligatorio	&	La visualizzazione di una fattura include l'indirizzo di spedizione dell'ordine	&	Interno\\ UC15.8	\tabularnewline
