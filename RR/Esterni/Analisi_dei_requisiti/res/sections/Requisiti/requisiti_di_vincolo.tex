...
\begin{center}
	...
	\begin{longtable}{ >{\centering}p{0.10\textwidth} >{\centering}p{0.25\textwidth}
		...
		R1V7	&	Obbligatorio	&	Il progetto deve utilizzare come minimo 4 ambienti di sviluppo: ambeinte di sviluppo locale, ambiente per il testing, ambiente per lo staging\glosp e ambiente di produzione. Il deploy in produzione è apprezzabile ma non obbligatorio.	&	Capitolato	\tabularnewline
		...
		R1V9.2	&	Obbligatorio	&	La Dapp\glosp dovrà essere accessibile ed utilizzabile utilizzando il browser e Mozilla FireFox, dalla versione 64	&	Verbale 2018-12-07 VE\_1.4	\tabularnewline
