...
R1V4.2	&	Obbligatorio	&	Per poter validare ed effettuare una transazione che richiede un trasferimento di \textit{Cubit}\glo, deve essere utilizzato MetaMask\glo	&	Capitolato	\tabularnewline
...
R1V7	&	Obbligatorio	&	Il progetto deve utilizzare come minimo i seguenti ambienti di sviluppo: ambiente di sviluppo locale, ambiente per il testing, ambiente per lo staging\glosp e ambiente di produzione. Il deploy in produzione è apprezzabile ma non obbligatorio	&	Capitolato	\tabularnewline
