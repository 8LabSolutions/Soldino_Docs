...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: l'utente effettua le operazioni necessarie all'acquisto di prodotti e servizi. Esse comprendono:
	 \begin{enumerate}[label=\alph*.]
		\item l'inserimento di un prodotto [UC6.1];
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: l'utente sta visualizzando un prodotto/servizio e clicca sul pulsante dedicato all'aggiunta dello stesso nel carrello virtuale;
