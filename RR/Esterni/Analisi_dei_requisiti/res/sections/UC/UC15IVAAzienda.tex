...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item in caso il saldo di un semestre risulti negativo (situazione di debito), l'azienda può procedere ad effettuare il pagamento [15.6] o può dilazionarlo\glosp [15.7];
	\end{itemize}
