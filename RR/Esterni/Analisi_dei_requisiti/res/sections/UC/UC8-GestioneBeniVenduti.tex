...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item visualizzare i propri prodotti/servizi attualmente in vendita [UC8.2];
	...
	\item \textbf{Postcondizione}: il sistema fornisce all'azienda le operazioni che possono essere svolte sui propri prodotti/servizi.	
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item inserire l'IVA del prodotto/servizio [UC8.1.4];
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: l'utente compila il campo relativo all'aliquota\glosp IVA del nuovo prodotto/servizio da inserire;
	\item \textbf{Precondizione}: il sistema ha reso disponibile il form per l'inserimento di un nuovo prodotto/servizio, in particolare è presente il campo per l'inserimento dell'aliquota\glosp IVA;
...
\subsubsection{UC8.3.4 - Modifica IVA}
\begin{itemize}
	\item \textbf{Attori Primari}: azienda;
