...
\subsubsection{UC11.1 - Visualizzazione lista aziende registrate}
 \begin{itemize}
	...
	\begin{itemize}
		\item \textbf{UC11.3}: l'utente può filtrare i risultati visualizzati inserendo una parola chiave;
	\end{itemize}
...
\subsubsection{UC11.3 - Ricerca}
\begin{itemize}
	\item \textbf{Attori Primari}: utente autenticato;
	\item \textbf{Descrizione}: l'utente può filtrare i risultati le informazioni che sta visualizzando inserendo una parola per la ricerca;
