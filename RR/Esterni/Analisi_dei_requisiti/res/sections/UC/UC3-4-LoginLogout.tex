...
\begin{itemize}
	...
	\item \textbf{Postcondizione}:
	l'utente viene individuato attraverso l'utilizzo del plugin MetaMask\glo.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Attori Secondari}:
	MetaMask\glo;
	\item \textbf{Descrizione}: l'utente richiede il logout dalla piattaforma web. Vengono visualizzate le informazioni necessarie per procedere alla procedura di logout, che deve essere effettuata attraverso l'utilizzo del plugin MetaMask\glo;
