...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{UC3.3}: se l'utente si è registrato ma il suo account è stato disabilitato;
	\end{itemize}
	\item \textbf{Precondizione}:
...
\begin{itemize}
	...
	\item \textbf{Postcondizione}: l'utente è consapevole che il proprio account è disabilitato, e può leggere la causa della disabilitazione del proprio account.
\end{itemize}
