...
\begin{itemize}
	...
	\item \textbf{Precondizione}:l 'utente non ha idea di come disconnettersi tramite MetaMask\glosp;
	\item \textbf{Postcondizione}: l'utente ha le abilità necessarie al conseguimento di un logout eseguito in modo corretto e sicuro tramite il plugin MetaMask\glosp.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Descrizione}: viene coniata una quantità definita di Cubit\glosp;
