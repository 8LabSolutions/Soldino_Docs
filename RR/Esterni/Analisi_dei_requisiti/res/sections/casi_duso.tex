...
\begin{description}[style=nextline]
	...
	\item[Governo\glosp] Si riferisce ad un utente che si è autenticato al sistema con il ruolo di governo\glo. Nelle parti successive del documento tale parola verrà intesa con tale significato, e non sarà più contrassegnata volontariamente come termine da glossario.
\end{description}
