...
\begin{itemize}
	...
	\begin{enumerate}[label=\alph*.]
		...
		\end{enumerate}
		In entrambi i casi in caso di rifiuto della proposta d'ordine, i soldi trattenuti verranno restituiti al compratore, mentre il venditore non invia nessun prodotto/servizio.
