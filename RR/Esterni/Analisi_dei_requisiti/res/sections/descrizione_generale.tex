...
\begin{itemize}
	...
	\begin{enumerate}[label=\alph*.]
		...
		\begin{enumerate}[label=\roman*.]
			\item \textbf{ordine azienda-cittadino}: durante il procedimento di acquisto il sistema provvede a sottrarre la somma dovuta al cittadino. L'ordine viene aggiunto nella lista degli ordini conclusi del cittadino. La fattura relativa a tale ordine viene aggiunta alle fatture di vendita dell'azienda;
			\item \textbf{ordine azienda-azienda}: per garantire che ad ogni ordine l'azienda-cliente riceva la fattura per dimostrare l'acquisto effettuato, e che l'azienda-venditrice riceva il pagamento, si è deciso di adottare un meccanismo di \textbf{escrow\glo}:
			\begin{enumerate}[label=\alph*.]
				\item l'azienda-cliente, durante il procedimento di acquisto, versa la somma dovuta nella piattaforma, dove verrà momentaneamente trattenuta;
				\item l'azienda-cliente riceve una conferma d'ordine\glo, e l'ordine viene aggiunto alle vendite in attesa di conferma dell'azienda-venditrice;
				\item all'approvazione, esplicita o automatica della conferma d'ordine, l'azienda-cliente riceve la fattura, mentre l'azienda-venditrice riceve i soldi trattenuti dal sistema, oltre che al poter accedere alla fattura a sua volta.
			\end{enumerate}
			
		\end{enumerate}
		Con l'adozione di tale meccanismo viene semplificata la gestione dell'IVA, in quanto tutte le fatture emesse sono state approvate, e quindi da considerarsi prive di errori. 
