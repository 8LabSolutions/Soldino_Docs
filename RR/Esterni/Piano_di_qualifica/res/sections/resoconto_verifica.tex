...
\begin{table}[H]
	...
	\begin{longtable}{ >{\centering}p{0.40\textwidth} >{\centering}p{0.25\textwidth}
		...
		\textit{Analisi dei Requisiti v1.0.0} & 85 & Superato
		
		\tabularnewline 
		\textit{Glossario v1.0.0} & 77 & Superato
				
		\tabularnewline 
		\textit{Norme di Progetto v1.0.0} & 76 & Superato
		
		\tabularnewline 
		\textit{Piano di Progetto v1.0.0} & 72 & Superato
		
		\tabularnewline 
		\textit{Piano di Qualifica v1.0.0} & 82 & Superato	
