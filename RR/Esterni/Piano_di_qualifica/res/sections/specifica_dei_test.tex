...
\begin{table}[H]
                ...
                \rowcolorhead
                 {\colorhead \textbf{Test}} &
                 {\colorhead \textbf{Descrizione}} & 
                 {\colorhead \textbf{Operazioni}} & 
                 {\colorhead\textbf{Stato}} & 
                 {\colorhead \textbf{Esito}} 	\\
				
                \rowcolorlight
                 {\colorbody 1} & {\colorbody Blabla} & 
                 {\colorbody Blabla} & {\colorbody Si} & {\colorbody No} 
				\\
				
				\rowcolordark
                 {\colorbody 2} & {\colorbody Blabla} & 
                 {\colorbody Blabla} & {\colorbody Si} & {\colorbody No} 
				\\	
				
				\rowcolorlight
                 {\colorbody 3} & {\colorbody Blabla} & 
                 {\colorbody Blabla} & {\colorbody Si} & {\colorbody No} 
				\\
				              
                \rowcolordark
                 {\colorbody 4} & {\colorbody Blabla} & 
                 {\colorbody Blabla} & {\colorbody Si} & {\colorbody No} 
				\\            
