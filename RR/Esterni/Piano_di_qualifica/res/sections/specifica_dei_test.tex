...
soddisfi i requisiti presentati dal proponente in forma esplicita ed essi vengono eseguiti durante il
...
\begin{table}[H]
	...
	\begin{longtable}{ >{\centering}p{0.20\textwidth} >{\centering}p{0.25\textwidth}
			>{\centering}p{0.30\textwidth} >{\centering}p{0.14\textwidth}}
