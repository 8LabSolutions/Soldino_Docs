...
\begin{table}[H]
	...
	\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.70\textwidth}
	...
	%	& \textbf{\color{white}Fonti} 
		...
		\texttt{TSOF2.4}	&	L'utente deve poter visualizzare un messaggio di errore nel caso in cui non
