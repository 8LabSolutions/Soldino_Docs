\section{Processi di Supporto}
	\subsection{Documentazione}
		...
		In tutti i documenti \LaTeX le tabelle sono scritte allo stesso modo dell'immagine sottostante, prestando attenzione ai comandi:
	...
	\subsection{Qualità}
	Per la trattazione della qualità si fa riferimento al Piano di Qualifica, dove sono descritte le modalità utilizzate per garantire la qualità nello sviluppo del progetto. In particolare, in tale documento:
	\begin{itemize}
