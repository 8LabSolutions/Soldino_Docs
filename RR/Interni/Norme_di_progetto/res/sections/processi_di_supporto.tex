...
\subsection{Documentazione}
	...
	\begin{itemize}
		...
		\item \textbf{Creazione della struttura}: viene creato un registro delle modifiche, indice che traccia gli argomenti trattati nel documento, e a seconda delle necessità, un indice relativo alle figure e uno relativo alle tabelle presenti nel documento;
