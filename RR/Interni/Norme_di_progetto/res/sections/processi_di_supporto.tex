...
\subsection{Documentazione}
	...
	\subsubsection{Norme tipografiche}
		...
		\begin{itemize}
			...
			\item \textbf{Corsivo}: vengono scritti in corsivo il nome del progetto \textit{Soldino}, il nome del gruppo \textit{8Lab Solutions} ed il nome del token\glosp coniato nella piattaforma,  \textit{Cubit};
