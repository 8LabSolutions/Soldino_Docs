\section{Processi Organizzativi}
	\subsection{Gestione Organizzativa}
		...
		\begin{itemize}
			...
			\item \textbf{Sistemi operativi}: i requisiti non indicano la necessità di usare un sistema operativo specifico, verranno quindi utilizzati sia Windows sia Linux dai diversi membri del team; %niente mac perché viva la povertà!
		\end{itemize}
