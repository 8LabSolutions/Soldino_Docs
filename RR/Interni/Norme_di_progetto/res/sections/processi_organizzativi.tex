\section{Processi Organizzativi}
	\subsection{Gestione Organizzativa}
		...
		\begin{itemize}
			...
			\item \textbf{Sistemi operativi}: i requisiti non indicano la necessità di usare un sistema operativo specifico, verranno quindi utilizzati sia Windows sia Linux dai diversi membri del team; %se qualcuno usa MacOS aggiungerlo non so neanche se ha senso aggiungerlo nella lista. Nessuno usa Mac, che poveri che siamo :(
		\end{itemize}
