...
\subsection{Documentazione}
	...
	\end{itemize}
		...
		\centerline{\textbf{verbale_tipologia_YYYY-MM-DD}} \newline \newline
...
%\end{comment}
		...
		\noindent{Ci sono vari tipi di test del software, ognuno dei quali ha un diverso oggetto di verifica e scopo. La codifica dei test è la seguente:
