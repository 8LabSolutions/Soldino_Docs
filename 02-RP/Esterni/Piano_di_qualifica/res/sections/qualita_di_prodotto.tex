...
\pagebreak
	...
	Capacità del prodotto di essere modificato, includendo correzioni, miglioramenti o adattamenti.
		...
		\subsubsection{Metriche}
			...
			\paragraph{Semplicità dei componenti}\mbox{}\\
			In JavaScript, si intende il numero di metodi in un oggetto, o componente. Un componente con pochi metodi ha uno scopo ben preciso e facilmente comprensibile.
			\begin{itemize}
			\item misurazione: numero di metodi per componente;
			\item valore preferibile $\leq$ 8;
			\item valore accettabile $\leq$ 15.
			\end{itemize}
		
			\paragraph{Semplicità dei contratti}\mbox{}\\
			La facilità di un contratto può essere rappresentata dal numero di funzioni per contratto. Un contratto con poche funzioni ha uno scopo ben preciso e facilmente comprensibile.
			\begin{itemize}
				\item misurazione: numero di funzioni per contratto;
				\item valore preferibile $\leq$ 8;
				\item valore accettabile $\leq$ 15.
			\end{itemize}
