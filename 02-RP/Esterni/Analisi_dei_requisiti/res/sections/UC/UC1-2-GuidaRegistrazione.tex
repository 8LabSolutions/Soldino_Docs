...
\begin{figure}[h]
	...
	\centering
	\caption{Registrazione ed errori annessi}
\end{figure}
\begin{itemize}
...
\subsubsection{UC2.1 - Inserimento dati account}
\begin{figure}[h]
	\includegraphics[width=6cm]{res/images/UC2-2RegistrazioneGenerale.png}
	\centering
...
\end{itemize}
\subsubsection{UC2.1.1 - Inserimento e-mail}
\begin{itemize}
	\item \textbf{Attori Primari}: utente non autenticato;
...
\end{itemize}
\subsubsection{UC2.2 - Inserimento dati anagrafici}
\begin{figure}[h]
...
\end{itemize}
\subsubsection{UC2.2.2 - Inserimento cognome}
\begin{itemize}
	\item \textbf{Attori Primari}: utente non autenticato;
...
\end{itemize}
\subsubsection{UC2.3.1 - Inserimento partita IVA}
\begin{itemize}
	\item \textbf{Attori Primari}: proprietario d'azienda;
...
\subsubsection{UC2.4 - Conferma ed invio dei dati}
\begin{itemize}
	\item \textbf{Attori Primari}: utente non autenticato;
