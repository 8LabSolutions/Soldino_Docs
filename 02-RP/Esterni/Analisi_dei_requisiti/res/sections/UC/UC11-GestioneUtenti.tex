...
\end{itemize}
\subsection{UC - Informazioni dettagliate di un'azienda}
...
\subsubsection{UC11.2 - Visualizzazione lista cittadini registrati}
\begin{itemize}
	\item \textbf{Attori Primari}: governo;
...
\subsubsection{UC - Informazioni dettagliate di un cittadino}
\begin{itemize}
	\item \textbf{Attori Primari}: governo;
