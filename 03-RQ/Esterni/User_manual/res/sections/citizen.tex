...
%
	...
	\subsection{Buying}
		...
		found right at the top of the page. After you start typing you will see 
		...
		\end{figure}
		\noindent The number on the cart shows you how many different products 
		...
		\end{figure}
		\noindent Here you will find every item you have previously selected 
		with their quantity and above them you will see the total for your 
		order. If you need to modify the quantity press the "+" or "-" buttons.
		\begin{figure}[H]
