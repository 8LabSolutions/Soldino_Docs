\section{Businesses}
	...
	then make sure that the slider is set on "Business".\\
	\begin{figure}[H]
...
%		
	...
	\end{figure}
		...
		press "Confirm" and it will be added to the products users can buy.
		...
		\end{figure}
		\noindent After you are done with the changes press "Confirm" to apply them.
	...
	\\A red value at the end of a trimester means that you will have to pay 
	...
	\end{figure}
		...
		At the end of a trimester, if you are in debt with the government, next 
