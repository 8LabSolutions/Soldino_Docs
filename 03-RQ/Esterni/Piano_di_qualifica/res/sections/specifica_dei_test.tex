...
\noindent La codifica dei seguenti test è presente nel documento \textit{Norme di Progetto v2.0.0}.

\subsection{Test di accettazione} 
	\renewcommand{\arraystretch}{1.5}
	\rowcolors{2}{pari}{dispari}
	
	\begin{longtable}{ >{\centering}p{0.10\textwidth} >{}p{0.655\textwidth}
	...
	%	& \textbf{\color{white}Fonti} 
		...
		\endhead	
		 ...
		 \end{itemize}
		 	&	NI	\tabularnewline
		 TSOF19.7	&	L'utente autenticato come azienda deve poter 
		 visualizzare in
