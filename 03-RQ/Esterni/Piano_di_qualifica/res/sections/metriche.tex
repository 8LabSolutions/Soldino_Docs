...
\begin{longtable}
	{ >{\centering}p{0.15\textwidth}
		...
		%\hline
		\rowcolor{white}
		\caption{EAC - Estimated At Completion}\\
		\rowcolorhead
...
\begin{longtable}{ >{\centering}p{0.15\textwidth}
		>{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth}}
	%\hline
	\rowcolor{white}\caption{VAC - Variance At Completion}\\
	\rowcolorhead
	\textbf{\color{white}RR} 
	& \textbf{\color{white}C} 
	& \textbf{\color{white}TB}
...
\begin{figure}[H]
	...
	\caption{VAC - Variance At Completion}
\end{figure}
\pagebreak
...
\begin{longtable}{ >{\centering}p{0.15\textwidth}
		 >{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth} >{\centering}p{0.15\textwidth}}
	%\hline
	\rowcolor{white}\caption{AC - Actual Cost}\\
	\rowcolorhead
	\textbf{\color{white}RR} 
	& \textbf{\color{white}C} 
	& \textbf{\color{white}TB}
