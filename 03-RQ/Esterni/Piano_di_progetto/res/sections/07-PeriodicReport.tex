...
rendicontato in quanto il capitolato è stato precedentemente aggiudicato 
e quindi il lavoro è svolto con lo scopo di sviluppare il progetto finale.
...
\begin{table}[H]
	...
	\begin{tabular}{c c c}
		...
		\rowcolorlight
		{\colorbody Responsabile} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}}  
		\\
		
		\rowcolordark
		{\colorbody Amministratore} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}}
		\\	
		
		\rowcolorlight
		{\colorbody Analista} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}} 
		\\
		
		\rowcolordark
		{\colorbody Progettista} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}} 
		\\
		
		\rowcolorlight
		{\colorbody Programmatore} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}} 
		\\
		
		\rowcolordark
		{\colorbody Verificatore} & {\colorbody PLACEHOLDER} & 
		{\colorbody \EUR{PLACEHOLDER}} 
		\\
		
		\rowcolorlight
		{\colorbody \textbf{Totale Preventivo}} & {\colorbody \textbf{PLACEHOLDER}} & 
		{\colorbody \textbf{\EUR{PLACEHOLDER}}} 
		\\
		
		\rowcolordark
		{\colorbody \textbf{Totale Consuntivo}} & {\colorbody \textbf{PLACEHOLDER}} & 
		{\colorbody \textbf{\EUR{PLACEHOLDER}}} 
		\\
		
		\rowcolorlight
		{\colorbody \textbf{Differenza}} & {\colorbody \textbf{PLACEHOLDER}} & 
		{\colorbody \textbf{\EUR{PLACEHOLDER}}} 
		\\		
	\end{tabular}
\end{table}
...
\subsubsection{Conclusioni}
Dai dati riportati nella tabella soprastante si evince che %PLACEHOLDER continuare
\subsubsection{Preventivo a finire}
Il bilancio economico risultante è %PLACEHOLDER continuare
\\
Di seguito sono riportate le motivazioni delle variazioni del monte ore di 
lavoro ricoperto dai diversi ruoli:
\begin{itemize}
%	\item \textbf{\textit{Responsabile}}: ;
	\item \textbf{\textit{Amministratori}}: ;
%	\item \textbf{\textit{Analisti}}: ;
	\item \textbf{\textit{Progettisti}}: ;
	\item \textbf{\textit{Programmatori}}: ;
	\item \textbf{\textit{Verificatori}}: .
\end{itemize}