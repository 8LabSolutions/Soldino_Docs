...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		...
		\subparagraph{Scopo} \mbox{}\\
			...
			\subparagraph{Aspettative} \mbox{}\\ \mbox{}\\
			\noindent Il processo ha come risultato la realizzazione dell'architettura\glosp del sistema così 
		...
		\subparagraph{Technology baseline} \mbox{}\\ \mbox{}\\	
			\noindent Redatta dal progettista, dovrà includere:
				\begin{itemize}
					...
					\item \textbf{tracciamento\glosp delle componenti}: ogni requisito deve riferirsi 
		...
		\paragraph{Codifica}
			...
			\subparagraph{Scopo} \mbox{}\\ \mbox{}\\
			Questa attività ha come obiettivo normare l'effettiva realizzazione del 
			...
			\subparagraph{Stile di codifica} \mbox{}\\ \mbox{}\\
			...
			ciascun membro del gruppo è tenuto a rispettare le seguenti norme:
				\begin{itemize}
					\item \textbf{indentazione}: i blocchi innestati devono essere correttamente 
						...
						consiglia di configurare adeguatamente il proprio editor o IDE, per esempio:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/indent.png}
						\caption{Esempio di indentazione}
					\end{figure}
					\item \textbf{parentesizzazione}: è richiesto di inserire 
					le parentesi di delimitazione dei costrutti in linea e non 
					al di sotto di essi, separando le parentesi con uno spazio, come si può
					vedere nei seguenti metodi:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/parentesi.png}
						\caption{Esempio di parentesizzazione}
					\end{figure}
					\item \textbf{scrittura dei metodi}: è preferibile, ove possibile, 
						mantenere i metodi brevi (poche righe di codice), come nell'esempio:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/moremethods.png}
						\caption{Esempio di scrittura dei metodi}
					\end{figure}
					\item \textbf{univocità dei nomi}: classi, metodi, variabili devono avere un 
						...
						come nell'esempio:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/functionName.png}
						\caption{Esempio di nomi per i metodi}
					\end{figure}
					\item \textbf{contratti e componenti}: i nomi dei contratti e dei componenti
					devono iniziare sempre con una lettera maiuscola, per esempio:
					\begin{figure}[H]
						\centering
						\includegraphics[width=0.5\linewidth]{res/images/contract.png}
						\caption{Esempio di contratto}
					\end{figure}
					
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/component.png}
						\caption{Esempio di componente}
					\end{figure}
					
					\item \textbf{costanti}: i nomi delle costanti devono essere scritti usando 
						solo maiuscole, per esempio:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/constants.png}
						\caption{Esempio di costanti}
					\end{figure}
					...
					\item \textbf{metodi}: i nomi dei metodi devono iniziare con una lettera 
						...
						lettera maiuscola (CamelCase\glo{}), come si può vedere dalla funzione che viene
						implementata e da quelle che vengono chiamate:
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/sonostanca.png}
						\caption{Esempio di scrittura nome dei metodi}
					\end{figure}
					\item \textbf{commenti}: deve essere presente un sintetico commento descrittivo precedente 
					all'implementazione di metodi e classi, per esempio: 
					\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/commento.png}
						\caption{Esempio di commento}
					\end{figure}
					\item \textbf{intestazione dei file}: ogni file deve presentare le seguenti informazioni:
						\begin{itemize}
							\item data di creazione;
							\item nome e cognome dell'autore;
							\item titolo del file;
							\item breve descrizione del contenuto del file.
						\end{itemize}
						Per esempio:
						\begin{figure}[H]
						\includegraphics[width=0.99\linewidth]{res/images/initialization.png}
						\caption{Esempio di intestazione del file}
					\end{figure}
					\item \textbf{lingua}: il codice, come anche i commenti, deve essere scritto 
						in lingua inglese come si può vedere dagli esempi presentati precedentemente.
				\end{itemize}
			...
			\subparagraph{Ricorsione}  \mbox{}\\ \mbox{}\\
