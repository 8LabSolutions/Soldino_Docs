...
%\end{itemize}
		...
		Ciascun membro del gruppo, a rotazione, deve ricoprire il ruolo che gli viene assegnato e che corrisponde all'omonima figura aziendale. Nel \textit{Piano di Progetto} vengono organizzate e pianificate le attività assegnate agli specifici ruoli. I ruoli che ogni componente del gruppo è tenuto a rappresentare sono descritti di seguito.
			...
			\begin{itemize}
				...
				\item redigere il documento \textit{Manuale Sviluppatore}.
			\end{itemize}
			...
			Il verificatore si occupa di controllare il prodotto del lavoro 
			svolto dagli altri membri del team, sia esso codice o 
			documentazione. Per le correzioni si affida agli standard definiti 
			nelle \textit{Norme di Progetto v4.0.0}, nonché alla propria 
			esperienza e capacità di giudizio.\\
		...
		Seguono le procedure che il gruppo adotta durante la realizzazione del progetto. 
			...
			Ogni incontro interno comincia con lo stand up meeting. Esso è un momento di confronto a cadenza quotidiana. Durante il meeting i membri si aggiornano sul lavoro svolto nel giorno precedente, e dichiarano il lavoro da fare nel giorno attuale, in accordo con gli incrementi definiti nel PdP. La durata del meeting può variare: da 10 minuti nel caso in cui i compiti siano già chiari, fino a 30 minuti nel caso ci siano decisioni organizzative da prendere.
			\newline \newline
			
			\noindent\textbf{Incontri interni del team} \newline \newline
		...
		\begin{itemize}
			...
			\item \textbf{Microsoft Project}: strumento utilizzato per la creazione dei diagrammi di Gantt;
	...
	Ogni componente del gruppo è libero di utilizzare per l'apprendimento personale altro materiale oltre a quello indicato nelle \textit{Norme di Progetto}. Nel caso in cui lo ritenesse utile, potrà inoltre condividere tale materiale, utilizzando il canale dedicato \textbf{link utili} della chat di Slack\glo. In suddetto canale, gli argomenti sono suddivisi per topic. I membri del canale sono tenuti a rispettare i suddetti topic per garantire l'ordine degli argomenti.