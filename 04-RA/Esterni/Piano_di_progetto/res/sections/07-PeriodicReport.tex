...
\begin{table}[H]
	...
	\begin{tabular}{c c c}
		...
		\rowcolorlight
		{\colorbody Responsabile} & {\colorbody 17(+0)} & 
		{\colorbody \EUR{510,00} (+\EUR{0,00})}  
		\\
		
		\rowcolordark
		{\colorbody Amministratore} & {\colorbody 16(+0)} & 
		{\colorbody \EUR{320,00} (+\EUR{0,00})}
		\\	
		...
		\rowcolordark
		{\colorbody Progettista} & {\colorbody 14(-4)} & 
		{\colorbody \EUR{308,00} (-\EUR{88,00})} 
		\\
		
		\rowcolorlight
		{\colorbody Programmatore} & {\colorbody 41(-9)} & 
		{\colorbody \EUR{615,00} (-\EUR{135,00})} 
		\\
		
		\rowcolordark
		{\colorbody Verificatore} & {\colorbody 72(+0)} & 
		{\colorbody \EUR{1080,00} (+\EUR{0,00})} 
		\\
		
		\rowcolorlight
		{\colorbody \textbf{Totale Preventivo}} & {\colorbody \textbf{160}} & 
		{\colorbody \textbf{\EUR{2.833,00}}} 
		\\
		
		\rowcolordark
		{\colorbody \textbf{Totale Consuntivo}} & {\colorbody \textbf{147}} & 
		{\colorbody \textbf{\EUR{2.610,00}}} 
		\\
		
		\rowcolorlight
		{\colorbody \textbf{Differenza}} & {\colorbody \textbf{13}} & 
		{\colorbody \textbf{-\EUR{223,00}}} 
		\\
		
		\rowcolordark
		{\colorbody \textbf{Totale con perdita(+\EUR{211,00})}} &  & 
		{\colorbody \textbf{-\EUR{12,00}}} 
		\\	
	\end{tabular}
\end{table}
...
\end{itemize}
\subsubsection{Preventivo a finire}
Il bilancio economico risultante è positivo, in quanto è stato raggiunto 
l'obiettivo previsto nel periodo precedente riguardante il risparmio di alcune 
ore legate a progettazione e codifica generale. Tutto ciò ha permesso di 
rientrare nel monte ore preventivato per la fase di validazione e collaudo, 
portando anche un guadagno finale di \EUR{12,00}. Questo deriva da un risparmio 
di ore totali pari a 13 che avrebbero portato ad un guadagno di \EUR{223,00}, 
ma considerando il debito del periodo precedente pari a \EUR{211,00}, il 
guadagno finale sopracitato è minimo.

\subsection{Consuntivo totale complessivo}
La seguente tabella presenta il consuntivo finale che include la totale durata 
del progetto, comprese le ore non rendicontate. \\
In totale il gruppo ha lavorato 1160 ore, corrispondenti a 145 ore pro capite.
\newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
\begin{table}[H]
	\centering\renewcommand{\arraystretch}{1.5}
	\caption{Consuntivo totale complessivo}
	\vspace{0.2cm}
	\begin{tabular}{l c M{0.20\textwidth}}
		
		
		\rowcolorhead 
		{\colorhead \textbf{Periodo}} &
		{\colorhead \textbf{Preventivo \EUR{}}} &
		{\colorhead \textbf{Consuntivo \EUR{}}}  \\ 
		
		\rowcolordark
		Analisi dei requisiti & 5.978,00 & 6.792,00\\
		\rowcolorlight
		Consolidamento dei requisiti & 820,00 & 820,00\\
		\rowcolordark
		Progettazione e codifica per la Technology Baseline & 4.389,00 &  4.245,00\\
		\rowcolorlight
		Progettazione di dettaglio e codifica & 7.090,00 & 7.445,00\\
		\rowcolordark
		Validazione e collaudo & 2.833,00 & 2.610,00\\
		\rowcolorlight
		Totale complessivo & 21.110,00 & 21.912,00\\
	\end{tabular}
\end{table}
\pagebreak
\subsection{Consuntivo totale rendicontato}
La seguente tabella presenta il consuntivo finale rendicontato, che esclude il periodo di analisi. \\
In totale il gruppo ha lavorato 105 ore con un risparmio economico complessivo 
di
\EUR{12,00}.
\newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
\begin{table}[H]
	\centering\renewcommand{\arraystretch}{1.5}
	\caption{Consuntivo totale del periodo rendicontato}
	\vspace{0.2cm}
	\begin{tabular}{l c M{0.20\textwidth}}
		...
		Validazione e collaudo & 2.833,00 & 2.610,00\\
		\rowcolorlight
		Totale rendicontato & 15.132,00 & 15.120,00\\
	\end{tabular}
\end{table}