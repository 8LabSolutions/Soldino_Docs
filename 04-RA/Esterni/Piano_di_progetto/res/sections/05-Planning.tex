...
Alla luce delle scadenze presentate nella \hyperlink{scadenze}{§1.5}, la pianificazione di progetto viene suddivisa nelle seguenti fasi:
\begin{enumerate}
	\item \textbf{Analisi};
...
\end{figure}
\subsubsection{Adattamento della pianificazione della fase}
A seguito del consuntivo della fase precedente descritto nella §6.4 è 
...
§4.5, si prevede di avere altri contatti con la proponente al fine 
