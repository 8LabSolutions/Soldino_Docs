\section{Citizens}
	...
	\end{figure}
	\noindent After you have completed all the fields with your data, press the
	\texttt{Sign up} button. If an entry is not valid (e.g. the email address
	does not contain a valid domain), the system will let you know it and you
	have to edit that field to continue. If all fields are valid, a pop-up
	window will ask you 
	...
	\textit{Soldino}'s own special token. Also, note that 1 Cubit equals 1 Euro.
		\subsection{Checking your balance}
