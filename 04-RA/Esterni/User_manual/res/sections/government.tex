\section{Government}
	...
	\subsection{Login}
	If you want to log on the Government account press the \texttt{Login} button on the 
...
\pagebreak
	...
	\end{figure}
		...
		\texttt{Amount} field at the bottom of the page then press \texttt{Mint}. You will 
		now see that the \texttt{Government supply} is increased by the chosen amount.
		\begin{figure}[H]
		...
		\end{figure} \mbox{}\\
		\noindent Note that the amount of cubit must be lower than the \texttt{Government  
	...
	This can be done by clicking on \texttt{Citizens List} or \texttt{Businesses List} in the 
	...
	\end{figure}
		...
		\texttt{Disable} button. Disabling an account means that it will not be able 
		...
		\texttt{Enable}. After being enabled an account will again be able to make 
