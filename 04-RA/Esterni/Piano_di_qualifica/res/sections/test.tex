\section{Test: specifica e stato}
...
\subsection{Test di accettazione} 
	...
	\begin{longtable}{ >{\centering}p{0.10\textwidth} >{}p{0.65\textwidth}
			>{\centering}p{0.05\textwidth} >{\centering}p{0.05\textwidth}}
...
\hypertarget{TAFD1}{TAFD1} & L'utente deve poter accedere alla guida dell'applicazione. All'utente viene
		 ...
		 \begin{itemize}
		 	...
		 	delle operazioni. 
		 \end{itemize} & \textit{I} & \textit{NS}\\ \tabularnewline
...
\hypertarget{TAFO2.3}{TAFO2.3} & L'utente deve poter visualizzare un messaggio di errore nel caso in cui la
		 ...
		 nel sistema. & \textit{I} & \textit{NS}\\ \tabularnewline
...
\subsubsection{Tracciamento test d'unità - metodi}
Segue il tracciamento dei test con i metodi che testano:
%TRACCIAMENTO TEST-METODI
		\renewcommand{\arraystretch}{1.5}
		\rowcolors{2}{pari}{dispari}
		
		\begin{longtable}{ >{\centering}p{0.07\textwidth} >{}p{0.85\textwidth}}
