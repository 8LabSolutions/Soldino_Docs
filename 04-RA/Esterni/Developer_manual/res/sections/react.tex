...
\pagebreak
\subsection{UML} 
\subsubsection{Presentational components}
\begin{figure}[h]
	\centering\includegraphics[scale = 0.3]{res/images/Presentational.png}
	\caption{Presentational components}
\end{figure}
\pagebreak
\subsubsection{Container components}
\begin{figure}[h]
	\centering\includegraphics[scale = 0.31]{res/images/Container.png}
